...
for subfolder in subfolders:
    ...
    output_table.append((subfolder, gc_peak_value, gc_rich_region, proportion_value,
                    gc_peak_value_r0, at_rich_region, proportion_value_r0))
    

# Print the output table
#for item in output_table:
#    subfolder = item[0]
#    print(subfolder, "R1 GC peak (%GC):", item[1])
#    print(subfolder, "GC Rich Region (Mbp):", item[2])
#    print(subfolder, "GC Rich Percentage:", item[3])
#    print(subfolder, "R0 GC peak (%GC):", item[4])
#    print(subfolder, "AT Rich Region (Mbp):", item[5])
#    print(subfolder, "AT Rich Percentage:", item[6])
#    print()


# Create the output summary file
with open("summary_gc_at_calculation.txt", "w") as output_file:
    ...
    for item in output_table:
        ...
        output_file.write(f"{subfolder} AT Rich Region (Mbp): {item[5]}\n")
        output_file.write(f"{subfolder} AT Rich Percentage: {item[6]}\n")
        output_file.write("\n")
